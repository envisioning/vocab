...
import { ChefHat, Server, Coffee, CreditCard, Brain, Timer, XCircle, CheckCircle } from "lucide-react";
...
const STATIONS: Station[] = [
  { id: "kitchen", name: "Kitchen API", icon: <ChefHat />, protocol: "POST", successRate: 0 },
