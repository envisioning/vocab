...
export default function AlgorithmAccordion() {
        ...
        `}>
            ...
            >
                <div className="flex items-center gap-4">
                    <div className="bg-white/90 dark:bg-gray-900/90 rounded-full p-3 shadow-inner">
                ...
                <div className="bg-white/20 dark:bg-gray-900/20 rounded-full p-2">
                    {isOpen ? (
            ...
            {isOpen && (
                <div className="bg-white dark:bg-gray-900 p-6 border-t border-white/10 dark:border-gray-800">
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 space-y-8 bg-white dark:bg-gray-900 rounded-3xl transition-colors duration-300">
            <div className="text-center space-y-4">
                <div className="flex justify-center items-center gap-3">
                    <div className="bg-gradient-to-r from-blue-400 to-purple-400 dark:from-blue-600 dark:to-purple-600 p-4 rounded-2xl shadow-lg">
