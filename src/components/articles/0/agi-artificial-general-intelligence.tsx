  ...
  const skills: AGISkill[] = [
    {
      ...
      mastery: 98,
      description:
        "Instant mastery of any programming language and complex system design",
    },
    {
      ...
      mastery: 95,
      description:
        "Generation of stunning artwork across all mediums and styles",
    },
    {
      ...
      mastery: 92,
      description:
        "Composition and performance of complex musical pieces in any genre",
    },
    {
      ...
      mastery: 99,
      description:
        "Advanced problem-solving and theoretical mathematics capabilities",
    },
    {
    ...
    },
    {
      ...
      mastery: 97,
      description:
        "Fluent communication in all human languages and translation",
    },
  ];
  ...
  useEffect(() => {
    const updateDimensions = () => {
      ...
      setDimensions({
        ...
        centerOffset: isMobile ? 140 : 240,
        topOffset: isMobile ? 260 : 480,
      });
    };
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white p-4 sm:p-8 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative text-center mb-8 sm:mb-12">
        ...
        <p className="text-sm sm:text-lg text-blue-200 max-w-2xl mx-auto px-4">
          Explore how AGI masters multiple domains simultaneously, achieving
          human-level or superior performance across diverse fields
        </p>
      </div>
      ...
      <div className="relative w-[280px] h-[280px] sm:w-[32rem] sm:h-[32rem] bg-gradient-to-r from-transparent via-blue-900/10 to-transparent rounded-full">
        ...
        {skills.map((skill, index) => {
          ...
          const x =
            Math.cos(angle) * dimensions.radius + dimensions.centerOffset;
          const y =
            Math.sin(angle) * dimensions.radius + dimensions.centerOffset;
              ...
              <div
                className={`relative group cursor-pointer bg-gray-800/80 p-2 sm:p-4 rounded-full shadow-lg 
                  ...
                  transform hover:scale-110 ${
                    selectedSkill === index ? "scale-125 border-green-400" : ""
                  }`}
                onClick={() => {
        ...
        <div
          ...
          style={{ top: `${dimensions.topOffset}px` }}
        >
      ...
      <div className="mt-8 sm:mt-16 text-center bg-gray-900/50 p-3 sm:p-6 rounded-xl backdrop-blur-sm border border-blue-500/30 max-w-[260px] sm:max-w-none mx-auto">
        ...
        <p className="mt-1 sm:mt-2 text-xs sm:text-base text-blue-200">
          Mastery Level: {skills[selectedSkill].mastery}%
        </p>
      </div>
    </div>
  );
