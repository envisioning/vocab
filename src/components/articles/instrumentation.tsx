...
import { Gauge, AlertTriangle, Activity, Cpu, Memory, Thermometer, Clock, Battery } from "lucide-react";
...
const SCENARIOS: Scenario[] = [
    {
        ...
        metrics: [
            ...
            { name: "Memory", value: 85, threshold: 90, unit: "%", icon: <Memory className="w-6 h-6" /> },
