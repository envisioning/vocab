            ...
            style={{
              backgroundColor:
                Object.values(categoryColors)[
                  i % Object.keys(categoryColors).length
                ],
      ...
      <div className="relative h-full">
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none">
          {relationships.map((rel, index) => {
            ...
            const isActive =
              activeNode && (activeNode === rel.from || activeNode === rel.to);
            ...
            return (
              <g key={`${rel.from}-${rel.to}`}>
                <line
                  ...
                  y2={`${toNode.y}%`}
                  stroke={
                    isActive ? categoryColors[fromNode.category] : "#CBD5E1"
                  }
        ...
        {nodes.map((node) => {
          ...
          const isRelated =
            activeNode && getRelatedNodes(activeNode).has(node.id);
          ...
          return (
            ...
            >
              ...
              <div
                className={`absolute w-32 -left-16 mt-2 text-center transition-opacity duration-300
