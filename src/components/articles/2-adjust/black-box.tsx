...
import { Box, ArrowRight, ChefHat, Brain, Coffee, Pizza, Salad, Laugh, Frown, Meh, Sun, Cloud, CloudRainWind } from "lucide-react";
...
const EMOTION_SCENARIOS: Scenario[] = [
    { input: "Sunny Day", output: "Happy", icon: <Sun />, resultIcon: <Laugh /> },
    { input: "Cloudy Day", output: "Neutral", icon: <Cloud />, resultIcon: <Meh /> },
    { input: "Rainy Day", output: "Sad", icon: <CloudRainWind />, resultIcon: <Frown /> }
];
