...
import { ChartGantt, Brain, Clock, BookOpen, Lightbulb, AlertCircle, ThumbsUp, ThumbsDown, RefreshCw } from "lucide-react";
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
            <div className="flex items-center gap-2 mb-6">
                <ChartGantt className="text-blue-500 w-6 h-6" />
