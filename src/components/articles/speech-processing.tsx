...
import { Mic, WavesIcon, Brain, MessageSquare, VolumeX, Volume2, Workflow } from "lucide-react";
...
const PROCESSING_STAGES: ProcessingStage[] = [
    ...
    { id: 3, name: "Analysis", icon: <WavesIcon className="w-6 h-6" />, description: "Analyze sound patterns" },
