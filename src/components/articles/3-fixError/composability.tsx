...
import { Music, Guitar, Drum, Microphone, Speaker, Mixer2, Cable, Play, Pause, RotateCcw } from "lucide-react";
...
const ComposabilityLab = () => {
  ...
  const availableComponents: AudioComponent[] = [
    ...
    { id: 'vocals', name: 'Vocals', type: 'instrument', icon: <Microphone className="w-8 h-8"/>, connections: [] },
    { id: 'mixer', name: 'Mixer', type: 'effect', icon: <Mixer2 className="w-8 h-8"/>, connections: [] },
