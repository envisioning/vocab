...
import { Search, Image, FileImage, Layers, Book, PieChart } from "lucide-react";
      ...
      case "convolution":
        return (
          <div className="relative">
            ...
            <Search className="absolute top-1/4 left-1/4 w-16 h-16 text-blue-500 animate-pulse" />
            <Search className="absolute top-1/2 left-1/2 w-16 h-16 text-green-500 animate-pulse" />
