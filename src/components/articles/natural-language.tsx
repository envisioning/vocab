...
import { Leaf, Globe, MessageCircle, Sprout, TreeDeciduous, Wind } from "lucide-react";
...
const LanguageGarden = () => {
    ...
    const getGrowthIcon = (stage: number) => {
        switch (stage) {
            ...
            case 1: return <Leaf className="text-green-500" />;
            case 2: return <TreeDeciduous className="text-green-500" />;
